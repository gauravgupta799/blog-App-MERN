...
const BlogStats =({stats})=>{
    ...
    return (
        <div className="flex gap-1 border-grey max-lg:mb-6 max-lg:pb-6 max-lg:border-b">
            {
...
export function ManageDraftBlogCard({blog}){
...
const deleteBlog = (blog, access_token, target)=>{
    // console.log(blog, access_token, target);
    ...
    .then(({data})=>{
        ...
        setStateFunc(preVal=>{
            ...
            if(!results.length && totoalDocs - 1 > 0 ) return null 
